      ...
      <div className="flex flex-col md:flex-row mt-8 md:mt-12 flex-grow">
        ...
        <div className="md:w-1/3 lg:w-1/4 flex flex-col items-center p-4 space-y-8">
          ...
          <div className="bg-gray-800 rounded-full shadow-lg border-4 border-blue-400">
            <img src="/logo maximus.webp" alt="Logo" className="h-32 w-32 md:h-40 md:w-40 lg:h-48 lg:w-48 rounded-full"/>
          </div>
        ...
        <div className="flex flex-col items-center w-full md:w-2/3 lg:w-3/5 max-w-full md:max-w-5xl space-y-4">
          <div className="text-center bg-gray-800 p-4 md:p-6 rounded-t-lg shadow-lg w-full">
            <h1 className="text-2xl md:text-4xl font-extrabold text-blue-400 mb-4">Bienvenue sur notre chatbot IA spécialisé IBM Maximo !</h1>
            <p className="text-gray-300 mt-2 leading-relaxed text-sm md:text-base">
            Ce chatbot, conçu pour répondre précisément à toutes vos questions sur la plateforme IBM Maximo, utilise les dernières avancées en intelligence artificielle conversationnelle pour vous offrir une expérience d'assistance interactive et efficace.
            </p>
          </div>
